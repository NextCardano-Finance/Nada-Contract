...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 450000000 * (10**9); // user must hold 1000,000 token
...
contract NADA is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Next Cardano";
    string constant _symbol = "NADA";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 45000000000000 * (10 ** _decimals);
